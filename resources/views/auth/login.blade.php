...
<html lang="en" >
  <head>
    ...
    <!-- Favicon icon -->
    <link rel="shortcut icon" type="image/png" href="app-assets/../app-assets/images/favicon.png"/>
    ...
    <div class="signup-login">
      <div class="sl-slider-caro owl-carousel">
        <div class="single-sl-slide">
          <img src="../app-assets/images/mac.png" alt="">
      ...
      <div class="sl-form-wrap">
        <header>
          <a href="#" class="logo">
            <img src="../app-assets/images/logo-2.png" alt="">
          </a>
